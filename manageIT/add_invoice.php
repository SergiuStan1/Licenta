    ...
    <div class="col-md-10">
    	<div class="main-content">
    		<div class="main-content-header">
    			<h2 class="white">Add Invoice</h2>
    		</div>
            <form action="create_invoice.php" method="post">
                        <div class="form-group">
                            <label class="white">Invoice no.</label>
                            <input type="number" name="noInvoice" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Company From</label>
                            <input type="text" name="companyFrom" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Company To</label>
                            <input type="text" name="companyTo" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Payment Method</label>
                            <input type="text" name="paymentMethod" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Amount</label>
                            <input type="number" name="amount" class="form-control">
                        </div>                    
                        <div class="form-group">
                            <label class="white">VAT</label>
                            <input type="number" name="vat" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Without VAT Amount</label>
                            <input type="number" name="withoutVat" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Payment DUE</label>
                            <input type="date" name="paymentDue" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Customer</label>
                            <input type="text" name="customerX" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Description</label>
                            <input type="text" name=" descriptionInvoice" class="form-control">
                        </div>
						<br>
