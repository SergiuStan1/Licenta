    ...
    <div class="col-md-10">
    	<div class="main-content">
    		<div class="main-content-header">
    			<h2 class="white">Add Employee</h2>
    		</div>
            <form action="insert_employee.php" method="post">
                        <div class="form-group">
                            <label class="white">Name</label>
                            <input type="text" name="nameEmployee" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Position</label>
                            <input type="text" name="position" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Date Of Employement To</label>
                            <input type="date" name="dateOfEmployement" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="white">Birth Date</label>
