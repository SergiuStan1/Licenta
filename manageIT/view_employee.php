			...
			<table class="table">
              <thead>
                <tr>
                  ...
                  <th class="white" scope="col">Position</th>
				  <th class="white" scope="col">Date Of Employement</th>
                  <th class="white" scope="col">Birth Date</th>
                  <th class="white" scope="col">Salary</th>
                  <th class="white" scope="col">Last Check In</th>
                  <th class="white" scope="col">Last Check Out</th>
                  <th class="white" scope="col">Created At</th>
                </tr>
              </thead>
              <tbody>
