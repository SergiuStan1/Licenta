...
<head>
    ...
    <title>Check in-Check out Employee</title>
    ...
    <div class="col-md-10">
    	<div class="main-content">
    		<div class="main-content-header">
    			<h2 class="white">Check in - Check Out Employee</h2>
    		</div>
           <form> 
            ...
            <div class="form-group">
            <form action="update_checkincheckout.php" method="post">
                <div class="form-group">
                    ...
                    <select class="form-control" name="employee_name">
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            echo "<option value='".$row['employeeId']."'>".$row['nameEmployee']."</option>";
                        }
                        ?>
                    </select>
                </div>
