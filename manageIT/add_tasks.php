    	...
    	<div class="main-content">
            ...
            <form action="insert_task.php" method="post">
						...
						<div class="form-group">
                            ...
                            <input type="date" name="dateEnded" class="form-control">
                        </div>
						<br>
